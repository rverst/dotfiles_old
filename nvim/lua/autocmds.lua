...
-- hightlight ToDo, BUG!, Info: fixMe etc.
utils.augrp('ag_hl_todo', {
    [[WinEnter,VimEnter * :silent! call matchadd('Todo', '\W\zs\([Tt][Oo][Dd][Oo]\|[Ii][Nn][Ff][Oo]\)[:!?]\?', -1)]],
    [[WinEnter,VimEnter * :silent! call matchadd('Todo', '\W\zs\([Ff][Ii][Xx][Mm][Ee]\|[Bb][Uu][Gg]\)[:!?]\?', -1)]]})
