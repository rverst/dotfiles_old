...
print("LSP INIT")
print(vim.inspect(require('lspinstall').installed_servers()))
local lsp_config = {}
local installed_servers = nil

function lsp_config.ls_installed(server)
    if installed_servers == nil then
...
-- install servers via :LspInstall <language>
--local servers = lspinstall.installed_servers() --{ 'gopls', 'clangd' }
